...
Permission.create(tabs: 'admin1', admin: true, superadmin: true)
Permission.create(tabs: 'admin2', admin: true, superadmin: true)
Permission.create(tabs: 'admin3', admin: true, superadmin: true)
Permission.create(tabs: 'admin4', admin: true, superadmin: true)
Permission.create(tabs: 'admin5', admin: true, superadmin: true)
Permission.create(tabs: 'admin6', admin: true, superadmin: true)
Permission.create(tabs: 'admin7', admin: true, superadmin: true)

Permission.create(tabs: 'moder1', moder: true, superadmin: true)
Permission.create(tabs: 'moder2', moder: true, superadmin: true)
Permission.create(tabs: 'moder3', moder: true, superadmin: true)

Permission.create(tabs: 'menu1', admin: true, moder: true, user: true, superadmin: true)
Permission.create(tabs: 'menu2', admin: true, superadmin: true)
Permission.create(tabs: 'menu3', moder: true, superadmin: true)
